...
(function(){
	...
	var _convert = function( colors, originalFilepath, ofnNoExt, originalContents, callback ){
		...
		var endWorkers = function(err, contents) {
	...
	Colorfy.convert = function( colorfied, colors, originalFilepath, ofnNoExt, originalContents, callback ){
	...
	Colorfy.prototype.convert = function( callback ){
		Colorfy.convert( this, this.colors, this.originalFilepath, this.ofnNoExt, this.originalContents, callback );
	};
