...
(function(){
	...
	var getColorConfig = function( str, extraColors ){
	...
	var Colorfy = function( filepath, extraColors, useExtraColors ){

		var colors = getColorConfig( filepath, extraColors );
		...
		if (this.extraColors && useExtraColors) {
			this.colors = {};
			for (var colorname in this.extraColors) {
					this.colors[colorname.replace(':','')] = this.extraColors[colorname];
			}
		} else {
			this.colors = colors;
		}
